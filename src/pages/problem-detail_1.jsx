...
const LeftColumn = ({ showSubmissions, setShowSubmissions, problem, getDifficultyClass, hasSubmitted, verdict, getVerdictClass, getVerdictText, id }) => (
  <div className="space-y-6">
    {!showSubmissions ? (
      ...
      <SubmissionsView setShowSubmissions={setShowSubmissions} id={id} />
    )}
  </div>
);

const ProblemDetailsView = ({ problem, setShowSubmissions, getDifficultyClass, hasSubmitted, verdict, getVerdictClass, getVerdictText }) => (
  <>
    <ProblemHeader
      problem={problem}
      setShowSubmissions={setShowSubmissions}
...
const ProblemHeader = ({ problem, setShowSubmissions, getDifficultyClass, hasSubmitted, verdict, getVerdictClass, getVerdictText }) => (
    <div className="bg-white rounded-lg p-6 border-2 border-black shadow-xl backdrop-blur-lg">
        <div className="flex justify-between items-start mb-4">
                    <div className="flex-1">
                      ...
                      <div className="flex flex-wrap items-center gap-4 text-sm text-gray-600">
                        <span>
                          Difficulty:
                          <span
                            className={`ml-2 px-3 py-1 rounded-full text-xs font-medium ${getDifficultyClass(
                              problem.difficulty
                            )}`}
                          >
                            {problem.difficulty}
                    ...
                    {hasSubmitted && verdict && (
                      <div className="ml-4">
                        <div
                          className={`flex items-center px-3 py-2 rounded-lg ${getVerdictClass(
                            verdict
                          )}`}
                        >
                          <svg
...
const SubmissionsView = ({ setShowSubmissions, id }) => (
  <div className="bg-white rounded-lg p-6 border-2 border-black shadow-xl backdrop-blur-lg">
...
const RightColumn = ({
  ...
  customInput,
  output,
}) => ( // The extra '}' before this arrow was the error
  <div className="space-y-6">
    <CodeEditorPanel
      selectedLanguage={selectedLanguage}
      handleLanguageChange={handleLanguageChange}
