...
export default function Login({ onToggleForm }) {
  ...
  return (
    <>
      <CardContent className="p-8">
        ...
        <form onSubmit={handleSubmit}>
          ...
          <div className="text-right mb-6">
            <Button
              variant="link"
              className="text-sm text-gray-400 h-auto p-0 hover:text-white"
            >
          ...
          <Button
            ...
            className="w-full bg-purple-600 hover:bg-purple-700 text-white font-bold text-md h-12"
          >
        ...
        <p className="text-center text-gray-400 text-sm mt-8">
          ...
          <Button
            ...
            className="font-semibold text-purple-400 hover:text-purple-300 pl-2"
          >
            Create Account
          </Button>
        </p>
      ...
      {/* This container is what displays the toasts */}
    </>
  );
}

const ShadcnInputField = ({
  icon: Icon,
  type,
  name,
  placeholder,
